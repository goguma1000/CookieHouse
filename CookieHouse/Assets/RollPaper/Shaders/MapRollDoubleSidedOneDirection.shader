...
Shader "Danilec/MapRollDoubleSidedOneDirection"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 switchResult2 = (((i.ASEVFace>0)?(( tex2D( _MainTex, i.uv_texcoord ) * _Color )):(( _Color * tex2D( _BackAlbedo, i.uv_texcoord ) ))));
...
/*ASEBEGIN
Version=18900
1920;0;1920;1019;2464.512;-392.8151;3.604575;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;12;-1275.848,-587.2426;Inherit;False;1252.009;1229.961;;11;14;4;5;8;10;11;6;9;3;1;2;Two sided shader using Switch by Face;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1227.159,65.5573;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D29CF8FD62CA52086F3A14EF38B7E4FBFC6D90F3